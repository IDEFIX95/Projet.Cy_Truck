...
int main() {
    ...
    fichier2 = fopen("total_trajet_decroissant(villededepart).csv", "r");
    if (fichier2 == NULL) {
        fprintf(stderr, "Erreur lors de l'ouverture du fichier\n");
        return 1;
    }

    fichier3 = fopen("total_trajets_decroissant.csv", "r");
    if (fichier3 == NULL) {
        fprintf(stderr, "Erreur lors de l'ouverture du fichier'%s'\n");
        return 1;
    }

    fichier1 = fopen("fichierfusionnertrajets.csv", "w");
    if (fichier1 == NULL) {
        fprintf(stderr, "Erreur lors de l'ouverture du fichier'%s'\n");
        return 1;
    }
    ...
    fichier1 = fopen("fichierfusionnertrajets.csv", "r");  
    if (fichier1 == NULL) {
        fprintf(stderr, "Erreur lors de l'ouverture du fichier\n");
        return 1;
    }
    ...
    fichier4 = fopen("fichier_final.csv", "w");  
    if (fichier4 == NULL) {
