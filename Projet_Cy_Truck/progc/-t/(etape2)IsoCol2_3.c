// CE PROGRAMME PERMET D'EXTRAIRE DES COLONNES 2 ET 3 DU FICHIER DATA.CSV VERS UN AUTRE FICHIER (AFIN DE TRAIVAILLER SUR LA PARTIE NOMBRE DE TRAJETS DES VILLES DE DEPART).
// ETAPE 2. 
...
#define FICHIER_SORTIE "fichier_col2&3.csv"
